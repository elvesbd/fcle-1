...
import (
	...
	"github.com/elvesbd/fclx/chatservice/internal/domain/entity"
	"github.com/elvesbd/fclx/chatservice/internal/domain/gateway"
...
func (uc *ChatCompletionUseCase) Execute(ctx context.Context, input ChatCompletionInputDTO) (*ChatCompletionOutputDTO, error) {
	...
	if err != nil {
		return nil, errors.New("error crating assistant message: " + err.Error())
	}
